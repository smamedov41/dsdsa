                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                <label><?= Lang::get('{Şəkil}') ?> * (<?=Lang::get('{Şəkillərin ölçüsü}')?>: <?=certificates_width?> x <?=certificates_height?> px)</label>
                                ...
                                <p>
                                    ...
                                    <span>Şəkillərin ölçüləri <?= certificates_width ?>x768 piksel olmalıdır.</span><br>
                                </p>
