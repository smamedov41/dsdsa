$(function(){
    ...
    $('#file').change(function(){
        ...
        app.uploader({
            ...
            progressBar: pb,
            progressText: pt,
            processor: '/cms/certificates/uploadphoto',
            finished: function(data){
                ...
                for(x=0; x < data.succeeded.length; x = x + 1){
                    ...
                    img.src = '/upload/Image/certificates/' + data.succeeded[x].file;
                    img.height = '100';

                    linkdelete = document.createElement('a');
                    linkdelete.href = '/cms/certificates/photodelete/' + data.succeeded[x].id +'/'+ $("#sid").val();
